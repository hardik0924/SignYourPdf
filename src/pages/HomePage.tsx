        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex space-x-4">
              <Link
                to="/auth"
                className="text-gray-700 hover:text-indigo-500 px-4 py-2 rounded-md text-sm font-medium transition-colors"
              >
                Sign In
              </Link>
              <Link
                to="/auth?mode=signup"
                className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white hover:opacity-90 px-6 py-2 rounded-md text-sm font-medium transition-colors"
              >
                Get Started
              </Link>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <div className="max-w-md mx-auto mb-12">
            <Link
              to="/auth?mode=signup"
              className="block w-full bg-gradient-to-r from-indigo-500 to-purple-500 hover:opacity-90 text-white text-lg font-semibold py-4 px-8 rounded-lg transition-colors mb-4"
            >
              Select PDF file
            </Link>
      ...
      <footer className="bg-white border-t border-gray-200 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-gray-500">
            <p>&copy;2025 SignBuddy. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
